...
> The LSAA-v2 is a derivative work based on the [LSAA dataset](https://github.com/ZPdesu/lsaa-dataset?tab=readme-ov-file), with additional semantic annotations created by the authors.  
